...
wget -O /tmp/liquidsoap.deb "https://github.com/cheztim/liquidsoap/releases/download/uadefix/liquidsoap-main-minimal_2.3.1-debian-bookworm-1_${ARCHITECTURE}.deb"
